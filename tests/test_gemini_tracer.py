...
#     client = genai.Client(api_key='AIzaSyAKbyvXpC1Dm--J1GkJeOZUal63DE-q4TE')
...
#     model = genai.GenerativeModel(api_key='AIzaSyAKbyvXpC1Dm--J1GkJeOZUal63DE-q4TE', model='gemini-1.5-flash')
