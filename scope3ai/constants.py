...
CLIENT_TO_PROVIDER = {
    ...
    CLIENTS.HUGGINGFACE_HUB: [PROVIDERS.HUGGINGFACE_HUB],
    CLIENTS.LITELLM: [PROVIDERS.LITELLM],
    CLIENTS.MISTRALAI: [PROVIDERS.MISTRALAI],
    CLIENTS.RESPONSE: [PROVIDERS.RESPONSE],
}
